...
const ProfileEditScreenComponent = ({
    ...
    return (
      <View style={{paddingHorizontal: 20}}>
        <View style={{flexDirection: 'row', alignItems: 'center'}}>
          <View style={{flex: 1.5}}>
            <Text style={{color: '#9DA5D3', fontSize: 20, paddingTop: 3}}>
              Name
            </Text>
          </View>
          <View
  ...
  const Lastname = () => {
    return (
      <View style={{flexDirection: 'row', alignItems: 'center'}}>
        <View style={{flex: 1.5}}>
          <Text style={{color: '#9DA5D3', fontSize: 18, paddingTop: 3}}>
            Lastname
          </Text>
        </View>
        <View
      ...
      <View style={{flexDirection: 'row', alignItems: 'center'}}>
        ...
        <View style={{flex: 1, alignItems: 'center', justifyContent: 'center'}}>
          <TouchableOpacity onPress={() => genderref.current.focus()}>
            <SvgImage source={DropDownIcon} style={{width: 22, height: 16}} />
          </TouchableOpacity>
        </View>
      </View>
    );
